...
export default () => {
    ...
    return (<div id="test-pro-layout" style={{
      ...
      <ProLayout bgLayoutImgList={[
        ...
        <SettingDrawer pathname={location.pathname} enableDarkTheme getContainer={() => document.getElementById('test-pro-layout')} settings={settings} onSettingChange={(changeSetting) => {
